...
function Content({ 
    ...
    return (
        <>
            ...
            <header>
                <h1><a href="/">Eureka Flash <span className="theme-intruder">Q</span>uiz</a></h1>
                <div></div>
              <ul>
                { 
                    handleLeaveQuiz ? 
            ...
            <footer>
                <p>&copy; {new Date().getFullYear()}, Eureka Flash Quiz</p>
                {/* <span>Made with ❤️ by 
                    <a target="_blank" rel="noopener noreferrer" onClick={gotoMyPortfolio}> Fiza98 </a>
                </span> */}
            </footer>
        </>
    )
