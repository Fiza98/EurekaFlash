        ...
        <div id="terms" onClick={handleOutsideClick}>
            <div id="content">
                ...
                <>
                    <h3>Introduction</h3>
                    <p>
                        Eureka Flash Quiz is an interactive web application designed to help users practice and test their knowledge 
                        ...
                        process. This quiz takes your name to only save your quiz progress and show you the results related only to you.
                    </p>
                    ...
                    <h4>Installation</h4>
                    <ol>
                        <li>Clone or download the Eureka Flash Quiz repository from <a rel="noreferrer" href="https://github.com/Fiza98/EurekaFlash" target={'_blank'}>GitHub</a>
                        </li>
                    ...
                    <h4>Live Demo</h4>
                    <p>Check out the live version of the project <a rel="noreferrer" href="https://eureka-flash.vercel.app/" target={'_blank'}>here</a></p>
